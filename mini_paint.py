...
try:
    with open(argv[1], 'r') as f:
        ...
        for i in f.readlines():
            ...
            if not operations_arguments[0] in ('r', 'R') or int(operations_arguments[3]) > canvas_arguments[0] \
                    or int(operations_arguments[4]) > canvas_arguments[1] or len(operations_arguments[5]) != 1:
